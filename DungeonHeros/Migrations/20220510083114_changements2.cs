...
{
    /// <inheritdoc />
    public partial class changements2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DungeonsDungeonId = table.Column<int>(type: "int", nullable: false),
                    MonstersMonsterId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DungeonMonster", x => new { x.DungeonsDungeonId, x.MonstersMonsterId });
                    table.ForeignKey(
                        name: "FK_DungeonMonster_Dungeons_DungeonsDungeonId",
                        column: x => x.DungeonsDungeonId,
                        principalTable: "Dungeons",
                        principalColumn: "DungeonId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DungeonMonster_Monsters_MonstersMonsterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FightedDungeonsDungeonId = table.Column<int>(type: "int", nullable: false),
                    TeamFightersTeamId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DungeonTeam", x => new { x.FightedDungeonsDungeonId, x.TeamFightersTeamId });
                    table.ForeignKey(
                        name: "FK_DungeonTeam_Dungeons_FightedDungeonsDungeonId",
                        column: x => x.FightedDungeonsDungeonId,
                        principalTable: "Dungeons",
                        principalColumn: "DungeonId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DungeonTeam_Team_TeamFightersTeamId",
                        column: x => x.TeamFightersTeamId,
                        principalTable: "Team",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DungeonMonster_MonstersMonsterId",
                table: "DungeonMonster",
                column: "MonstersMonsterId");

            migrationBuilder.CreateIndex(
                name: "IX_DungeonTeam_TeamFightersTeamId",
                table: "DungeonTeam",
